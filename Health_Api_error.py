...
def apicall():
    try:
        ...
        print(str(e))
        error.raised(0x4,"Error while creating socket")
    ...
    try:
        ...
        if int(msg["data"]["status"]) == 200:
            ...
            error.raised(0x8,"API failed")
    except Exception as e:
        print(str(e))
        error.raised(0x16,"Error while calling Health Api")
...
def net_event(sc):
    try:
        ...
        print(str(e))
        error.raised(0x32,"Error in Backup API call")
apicall()
